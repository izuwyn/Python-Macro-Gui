...
class MacroApp:
    ...
    def _run(self):
        ...
        for i, (row_num, value, col_b, col_c) in enumerate(values):
            ...
            result = self._process_record(value, col_b, col_c, row_num, ws)
    ...
    def _process_record(self, value, col_b, col_c, row_num, ws):
        try:
            pyperclip.copy("")
            ...
            if "NVC PACK" in clipboard_content.upper():
                ...
                ws.cell(row=row_num, column=2).value = clipboard_content
                return 'skip'
